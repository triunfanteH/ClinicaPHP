...
<body>
    ...
    <nav id="sidebar-wrapper">
        <ul class="sidebar-nav">
            ...
            <li>
                <a href="#" onclick = $("#menu-close").click(); >Consultas Requisitadas: <?php echo $consultas ?> </a>
            </li>
...
<div id="fundo">
    ...
    $conexao = new Connection();
    $sql='select * from consulta inner join paciente on consulta.idPaciente=paciente.id where status="1";';
    ...
    foreach ($resultado as $linha){
        ...
        echo '<th>';
        echo '<a href="indexAtender.php?id='.$linha->id.'" class="text-warning">';
        echo '[Atender]';
        echo '</a>';
        echo '</th>';
        echo '</tr>';
